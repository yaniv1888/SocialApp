        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ position: "absolute", top: 64, alignItems: "center", width: "100%" }}>
                    <Text style={styles.greeting}>{`שלום!\nהירשם על מנת להתחיל.`}</Text>
                ...
                <View style={styles.form}>
                    <View>
                        <Text style={{color: "#8A8F9E",marginLeft:270}}>שם מלא  </Text>
                        <TextInput
                            style={styles.input}
                    ...
                    <View style={{ marginTop: 32 }}>
                        <Text style={{color: "#8A8F9E",marginLeft:280}}>אימייל</Text>
                        <TextInput
                            style={styles.input}
                            autoCapitalize="none"
                    ...
                    <View style={{ marginTop: 32 }}>
                        <Text style={{color: "#8A8F9E",marginLeft:275}}>סיסמא</Text>
                        <TextInput
                            style={styles.input}
                            secureTextEntry
                            autoCapitalize="none"
